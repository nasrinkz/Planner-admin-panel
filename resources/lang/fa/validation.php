...
return [
    ...
    */
    ...
    'image' => ':attribute باید فرمت معتبر داشته باشد.',
    ...
    */
    ...
    'custom' => [
        'category_name' => 'نام دسته بندی',
            'password' => [
                'regex' => 'رمزعبور باید شامل حروف انگلیسی و اعداد باشد.',
            ],
        'userName' => [
            'regex' => 'استفاده از کاراکترهایی غیر از حروف انگلیسی و اعداد مجاز نیست.',
        ],
    ],
    ...
    */
    ...
    'attributes' => [
        ...
        'abstract' => 'خلاصه فیلم',
        'selectedGenres' => 'ژانر',
        'selectedDirectors' => 'کارگردان',
        'selectedAuthors' => 'نویسنده',
        'selectedActors' => 'بازیگر',
        'selectedKeyWords' => 'کلمات کلیدی',
        'selectedProducers' => 'تهیه کننده',
        'selectedCategory' => 'دسته بندی',
        'items' => 'گزینه ها',
        'question' => 'سوال',
        'keywordTitle'=> 'کلمه کلیدی',
        'mobileNumber'=> 'شماره موبایل',
        'data.userName'=> 'نام کاربری',
        'data.password'=> 'رمزعبور',
        'userName'=> 'نام کاربری',
