...
class GhamariListComponent extends Component
{
    use WithPagination;
    ...
    public function mount(){
        $events = Event::where('typeId',3)->with(['category'])->latest()->paginate($this->paginate_num);
    }
    ...
    {
        $events = Event::where('typeId',3)->with(['category'])->latest()->paginate($this->paginate_num);
        return view('livewire.manage-events.ghamari-list-component',['events'=>$events]);
    }
}
